...
- 熟练使用`React、React-query、Zustand、Antd`等技术栈,对组件化开发、常见优化手段有一定了解和实战
...
### 瑜币任务系统
我在此项目负责了哪些工作，分别在哪些地方做得出色/和别人不一样/成长快，这个项目中，
我最困难的问题是什么，我采取了什么措施，最后结果如何。这个项目中，
我最自豪的技术细节是什么，为什么，实施前和实施后的数据对比如何，同事和领导对此的反应如何。


### 每日瑜伽APP后台管理系统
我在此项目负责了哪些工作
哪些地方做得出色/和别人不一样/成长快
我最困难的问题是什么，我采取了什么措施，最后结果如何。
我最自豪的技术细节是什么，为什么，实施前和实施后的数据对比如何，同事和领导对此的反应如何。
...
- 每日瑜伽官网(pc)（每个公司写2~3个核心项目就好了，如果你有非常大量的项目，那么按分类进行合并，每一类选一个典型写出来。其他的一笔带过即可。）
- 用户分组
- 工时填报(内部系统)
